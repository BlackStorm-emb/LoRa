...
void ST7735_FillRectangle(uint8_t x, uint8_t y, uint8_t h, uint8_t w, uint16_t color);
void ST7735_FillScreen(uint16_t color);
void ST7735_DrawImage(uint8_t x, uint8_t y, uint8_t g, uint8_t w, const uint16_t* data);
